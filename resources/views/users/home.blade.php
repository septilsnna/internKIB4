        ...
        <div class="col-md-4 mt-3">
            <div class="card shadow" style="height: 300px; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="/search/colleges" style="color:#163254">Kampus</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-3">
            <div class="card shadow" style="height: 300px; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="/search/scholarships" style="color:#163254">Beasiswa</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-3">
            <div class="card shadow" style="height: 300px; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="/search/events" style="color:#163254">Seminar/Workshop</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-3">
            <div class="card shadow" style="height: 300px; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="/search/competitions" style="color:#163254">Lomba</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-3">
            <div class="card shadow" style="height: 300px; border-radius: 10px;">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <a href="/search/vacancy" style="color:#163254">Lowongan</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container my-5 mt-3 pb-5"
    style="font-size: 20px; font-family: 'Quicksand', sans-serif; color: #163254; font-weight:bold">
    <h3 class="text-center my-3">Informasi Seminar dan Workshop</h3>
    <div class="row">
        @foreach($events as $d)
